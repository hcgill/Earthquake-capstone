...
name to be fairly significant predictors.
...
In the binomial regression, both relative and absolute effects were tested to
give probabilities for each plate. In the relative effect, values represent how 
adding plate information increases the odds of a major earthquake.
...
have the highest probability of experiencing a major tremor. 
