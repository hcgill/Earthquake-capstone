...
platein this distribution are minimal, with the majority of values very close to 
zero. This data again makes sense as the effect each plate would have on the 
